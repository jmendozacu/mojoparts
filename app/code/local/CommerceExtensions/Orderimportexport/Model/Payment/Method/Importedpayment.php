...
class CommerceExtensions_Orderimportexport_Model_Payment_Method_Importedpayment extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'imported';

    protected $_infoBlockType = 'commerceextensions_orderimportexport/importedpayment';
