    ...
    extends Ess_M2ePro_Model_Amazon_Listing_Product_Instruction_SynchronizationTemplate_Checker_Abstract
{
    ...
    private function isMeetRevisePriceRegularRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetRevisePriceBusinessRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseDetailsRequirements()
    {
        ...
        if (!$amazonSynchronizationTemplate->isReviseUpdateDetails()) {
            return false;
        }
    ...
    private function isMeetReviseImagesRequirements()
    {
        ...
        if (!$amazonSynchronizationTemplate->isReviseUpdateImages()) {
            return false;
        }
