    ...
    extends Mage_Eav_Model_Convert_Parser_Abstract
{
    ...
    public function unparse()
    {
			 ...
			 $select_qry = "SELECT ".$prefix."eav_attribute.*, ".$prefix."eav_attribute_set.*, ".$prefix."eav_attribute_group .*, ".$prefix."catalog_eav_attribute.* FROM `".$prefix."eav_attribute` INNER JOIN ".$prefix."eav_entity_attribute ON ".$prefix."eav_entity_attribute.entity_type_id = ".$prefix."eav_attribute.entity_type_id AND ".$prefix."eav_entity_attribute.attribute_id = ".$prefix."eav_attribute.attribute_id INNER JOIN ".$prefix."catalog_eav_attribute ON ".$prefix."catalog_eav_attribute.attribute_id = ".$prefix."eav_attribute.attribute_id INNER JOIN ".$prefix."eav_attribute_set ON ".$prefix."eav_attribute_set.attribute_set_id = ".$prefix."eav_entity_attribute.attribute_set_id INNER JOIN ".$prefix."eav_attribute_group ON ".$prefix."eav_attribute_group.attribute_group_id = ".$prefix."eav_entity_attribute.attribute_group_id WHERE ".$prefix."eav_attribute.entity_type_id = '".$EntityTypeId."'".
                                                                             /* filter by is_user_defined */
                                                                             (($is_user_defined!=null)?(" AND ".$prefix."eav_attribute.is_user_defined='$is_user_defined'"):'').
                           " LIMIT ".$recordlimit."";
