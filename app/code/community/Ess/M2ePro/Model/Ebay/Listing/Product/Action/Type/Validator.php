        ...
        foreach ($this->getEbayListingProduct()->getVariations(true) as $variation) {
            ...
            foreach ($variation->getOptions(true) as $option) {
                ...
                if (count($uniqueAttributesValues) > 5) {
                    ...
                    // M2ePro_TRANSLATIONS
                    // Variations of this Magento Product are out of the eBay Variational Items limits. Its number of Variational Attributes is more than 5. That is why, this Product cannot be updated on eBay. Please, decrease the number of Attributes to solve this issue.
                    $this->addMessage(
                ...
                if (count($uniqueAttributesValues[$option->getAttribute()]) > 60) {
                    ...
                    // M2ePro_TRANSLATIONS
                    // Variations of this Magento Product are out of the eBay Variational Items limits. Its number of Options for some Variational Attribute(s) is more than 60. That is why, this Product cannot be updated on eBay. Please, decrease the number of Options to solve this issue.
                    $this->addMessage(
                        'Variations of this Magento Product are out of the eBay Variational Items limits.
            ...
            if ($totalVariationsCount > 250) {
                ...
                // M2ePro_TRANSLATIONS
                // Variations of this Magento Product are out of the eBay Variational Items limits. The Number of Variations is more than 250. That is why, this Product cannot be updated on eBay. Please, decrease the number of Variations to solve this issue.
                $this->addMessage(
                    'Variations of this Magento Product are out of the eBay Variational Items limits.
