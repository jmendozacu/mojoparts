    ...
    extends Ess_M2ePro_Model_Ebay_Listing_Product_Instruction_SynchronizationTemplate_Checker_Abstract
{
    ...
    private function isMeetReviseTitleRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseSubtitleRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseDescriptionRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseImagesRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseCategoriesRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetRevisePaymentRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseShippingRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseReturnRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
    ...
    private function isMeetReviseOtherRequirements()
    {
        $listingProduct = $this->input->getListingProduct();
