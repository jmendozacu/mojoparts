    ...
    extends Ess_M2ePro_Controller_Adminhtml_Amazon_MainController
{
    ...
    private function processSellingFormatTemplateChange(array $oldData, array $newData,
    ...
    private function processSynchronizationTemplateChange(array $oldData, array $newData,
                                                          array $affectedListingsProductsData)
    {
        if (empty($affectedListingsProductsData) ||
