...
class CommerceExtensions_Sitetransferimportexport_Block_System_Convert_Gui_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('dataflow/profile_collection')
            ->addFieldToFilter('is_commerce_extensions', 99);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('entity_type', array(
            ...
            'index'     => 'entity_type',
            'type'      => 'options',
            'options'   => array('product'=>'Products', 'attribute'=>'Attributes', 'order'=>'Orders', 'category'=>'Categories', 'customer'=>'Customers', 'customerreviews'=>'Customer Reviews', 'couponcode'=>'Shopping Cart Price Rules'),
            'width'     => '160px',
        ));
