    ...
    extends Ess_M2ePro_Controller_Adminhtml_Development_CommandController
{
    ...
    /**
     * @title "Listing -> Product -> AutoActions -> Process Magento Product Websites Updates"
     */
    public function listingProductAutoActionsProcessMagentoProductWebsitesUpdatesAction()
    {
        $taskTitle = 'Listing -> Product -> AutoActions -> Process Magento Product Websites Updates';
