    ...
    extends Ess_M2ePro_Model_Connector_Command_Pending_Processing_Single_Runner
{
    ...
    public function processExpired()
    {
        ...
        if (!$this->getProcessingAction()->isPrepared()) {
            return;
        }
    ...
    public function prepare()
    {
        ...
        $this->getProcessingAction()->setData('request_data', Mage::helper('M2ePro')->jsonEncode($params['request_data']));
    ...
    protected function getProcessingAction()
    {
        ...
        $processingActionCollection = Mage::getResourceModel('M2ePro/Amazon_Listing_Product_Action_Processing_Collection');
