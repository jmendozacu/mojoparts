...
class Ess_M2ePro_Block_Adminhtml_Amazon_Listing_Add_NewAsin_Manual_SkipPopup
    extends Mage_Adminhtml_Block_Template
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('M2ePro/amazon/listing/add/search_asin/manual/skip_popup.phtml');
    }
