...
class CommerceExtensions_Orderimportexport_Model_Convert_Adapter_Ordercreate extends Varien_Object //CommerceExtensions_Orderimportexport_Model_Convert_Adapter_Importorders
{
    /**
    ...
    {
        $this->_session = Mage::getModel("commerceextensions_orderimportexport/convert_adapter_sessionquote");
    }
...
//        }
    ...
    protected function getServiceQuoteModel($quote) {
        return Mage::getModel("commerceextensions_orderimportexport/convert_adapter_servicequote", $quote); //new CommerceExtensions_Orderimportexport_Model_Convert_Adapter_Servicequote($quote);
    }
